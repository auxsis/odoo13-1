...
//        this.barcode_reader = new devices.BarcodeReader({'pos': this, proxy:this.proxy});
    ...
    models: [
    {
        ...
        model:  'res.company',
        fields: [ 'currency_id', 'email', 'website', 'company_registry', 'vat', 'name', 'phone', 'partner_id' , 'country_id', 'tax_calculation_rounding_method', 'social_facebook', 'social_instagram'],
